...
// recois et affiche data (hostname) puis envoie le sien 
int envoie_operateur_numeros(int socketfd) {
  ...
  // Envoie son hostname
  char hostName[100] = "HostName2";
  strcpy(data2, "HostName: ");
  strcat(data2, hostName);

  //Si le message commence par le mot: 'Hostname:' 
